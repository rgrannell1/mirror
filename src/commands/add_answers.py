...
def image_answers_to_relations(
    ...
    if question_id == "q01":
        ...
        return [(source, "rating", target)]
    elif question_id == "q06":
        if target == "Yes":
            return [(source, "animal_behaviour", "Flying")]

        return []
    elif question_id == "q07":
        if target == "Yes":
            return [(source, "contains", "Water")]
        else:
            return []
    elif question_id == "q08":
        return [(source, "waterway_type", target)]
    elif question_id == "q09":
        return [(source, "cityscape_focus", target)]
    elif question_id == "q10":
        return [(source, "waterway_type", target)]
    elif question_id == "q11":
        return [(source, "description", target), (target, "is-a", "Description")]
    elif question_id == "q12":
        return [(source, "contains", target)]
    elif question_id == "q13":
        return [(source, "contains", target), (target, "is-a", "Plane")]
        ...
        return [(source, "contains", target), (target, "is-a", "Named Body of Water")]
    elif question_id == "q17":
        return [(source, "contains", target), (target, "is-a", "Helicopter")]
    else:
