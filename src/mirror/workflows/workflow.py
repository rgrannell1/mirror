...
from mirror.commands.enrich.enrich import EnrichData
from mirror.commands.publish.publish import PublishArtifacts
from mirror.commands.scan.scan import ScanMedia
from mirror.commands.upload.upload import UploadMedia
...
def MirrorWorkflow(context, input, dependencies):
    ...
    OUTPUT_DIR = "/home/rg/Code/websites/photos.rgrannell.xyz/manifest"

    yield Await(PublishArtifacts(
